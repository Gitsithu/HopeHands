...
<div class="text-center">
    ...
    <div class="mt-8 flex justify-center space-x-4">
        <a href="{{ route('donators') }}" class="px-6 py-3  bg-gray-300 text-black font-semibold rounded-lg">
            အလှူရှင်
        </a>
        <a href="{{ route('receivers') }}" class="px-6 py-3 bg-gray-300 text-black font-semibold rounded-lg hover:bg-gray-400">
            အကူအညီတောင်းခံသူ
        </a>
        {{-- <a href="{{ route('articles') }}" class="px-6 py-3 bg-[#44991a] text-black font-semibold rounded-lg hover:bg-gray-400">
            သတင်းများ
        </a> --}}
    </div>
