        ...
        if (data.length === 0) {
            resultsContainer.innerHTML = `
                <div class="col-span-full text-center py-12">
                    ...
                    <p class="mt-1 text-gray-500">There are currently no donors available.</p>
                </div>
            `;
            return;
        }
                ...
                <div class="p-5">
                    <div class="flex items-start justify-between">
                        <div>
                         ...
                         <span class="inline-block mt-1 px-2.5 py-0.5 text-xs font-medium rounded-full bg-blue-100 text-blue-800">
